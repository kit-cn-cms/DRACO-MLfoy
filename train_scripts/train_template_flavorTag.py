...
input_samples.addSample(options.getDefaultName("b") ,  label = "b" , normalization_weight = options.getNomWeight(), total_weight_expr = weight_expr )
input_samples.addSample(options.getDefaultName("c") ,  label = "c" , normalization_weight = options.getNomWeight(), total_weight_expr = weight_expr )
input_samples.addSample(options.getDefaultName("lf") ,  label = "lf" , normalization_weight = options.getNomWeight(), total_weight_expr = weight_expr )
