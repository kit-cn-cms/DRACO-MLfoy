...
def ttH_SL_legacy_opt44_tensorflow(input_placeholder, keras_model):
    # Get weights as numpy arrays
    weights = {}
    for layer in keras_model.layers:
        for weight, array in zip(layer.weights, layer.get_weights()):
    ...
    w4 = tf.get_variable('w4', initializer=weights['DenseLayer_3_1/kernel:0'])
    b4 = tf.get_variable('b4', initializer=weights['DenseLayer_3_1/bias:0'])
    w5 = tf.get_variable('w5', initializer=weights['outputLayer_1/kernel:0'])
    b5 = tf.get_variable('b5', initializer=weights['outputLayer_1/bias:0'])
...
def ttH_SL_legacy_opt43_tensorflow(input_placeholder, keras_model):
    # Get weights as numpy arrays
    weights = {}
    for layer in keras_model.layers:
        for weight, array in zip(layer.weights, layer.get_weights()):
...
def ttH_SL_legacy_STXS_opt44_tensorflow(input_placeholder, keras_model):
    # Get weights as numpy arrays
    weights = {}
    for layer in keras_model.layers:
        for weight, array in zip(layer.weights, layer.get_weights()):
...
def ttH_SL_legacy_STXS_opt43_tensorflow(input_placeholder, keras_model):
    # Get weights as numpy arrays
    weights = {}
    for layer in keras_model.layers:
        for weight, array in zip(layer.weights, layer.get_weights()):
