# python evaluating_modified_models.py -i "/local/scratch/ssd/ycung/new_h5_files_2017_v2" -o comparison_modified_models -c ge4j_ge3t -v new_variableset_25_v2 --binary -S ttH -q -P --restorefitdir /home/ycung/Desktop/DRACO-MLfoy_thesis/workdir/training_ANN_150N/QT_ANN_150N_training_0_ge4j_ge3t/fit_data.pck
# global imports
...
plot_correlation_two_NNs(nn5_pred, nn6_pred, nn5_pred_std, nn6_pred_std, "(BNN)" + r'$^{\rm{DF-Mod\ 1}}_{1 \times 50}$', "(BNN)" + r'$^{\rm{DF-Mod\ 1,T}}_{1 \times 50}$', output_dir, "modV1_BNN_Flip_comparison", privateWork=options.isPrivateWork())
plot_correlation_two_NNs(nn7_pred, nn8_pred, nn7_pred_std, nn8_pred_std, "(BNN)" + r'$^{\rm{DF-Mod\ 2}}_{1 \times 50}$', "(BNN)" + r'$^{\rm{DF-Mod\ 2,T}}_{1 \times 50}$', output_dir, "modV3_BNN_Flip_comparison", privateWork=options.isPrivateWork())
...
plot_correlation_two_NNs(nn11_pred, nn12_pred, nn11_pred_std, nn12_pred_std, "(BNN)" + r'$^{\rm{DV-Mod\ B}}_{1 \times 50}$', "(BNN)" + r'$^{\rm{DV-Mod\ B,T}}_{1 \times 50}$', output_dir, "modV2_BNN_Var_comparison", privateWork=options.isPrivateWork())
...
plot_correlation_two_NNs(nn1_pred, nn5_pred, nn1_pred_std, nn5_pred_std, "(BNN)" + r'$^{\rm{DV}}_{1 \times 50}$', "(BNN)" + r'$^{\rm{DF-Mod\ 1}}_{1 \times 50}$', output_dir, "BNN_Var_Flip_modV1_comparison", privateWork=options.isPrivateWork())
plot_correlation_two_NNs(nn1_pred, nn7_pred, nn1_pred_std, nn7_pred_std, "(BNN)" + r'$^{\rm{DV}}_{1 \times 50}$', "(BNN)" + r'$^{\rm{DF-Mod\ 2}}_{1 \times 50}$', output_dir, "BNN_Var_Flip_modV2_comparison", privateWork=options.isPrivateWork())
...
plot_correlation_two_NNs(nn2_pred, nn6_pred, nn2_pred_std, nn6_pred_std, "(BNN)" + r'$^{\rm{DV,T}}_{1 \times 50}$', "(BNN)" + r'$^{\rm{DF-Mod\ 1,T}}_{1 \times 50}$', output_dir, "QT_BNN_Var_Flip_modV1_comparison", privateWork=options.isPrivateWork())
plot_correlation_two_NNs(nn2_pred, nn8_pred, nn2_pred_std, nn8_pred_std, "(BNN)" + r'$^{\rm{DV,T}}_{1 \times 50}$', "(BNN)" + r'$^{\rm{DF-Mod\ 2,T}}_{1 \times 50}$', output_dir, "QT_BNN_Var_Flip_modV2_comparison", privateWork=options.isPrivateWork())
...
plot_correlation_two_NNs(nn3_pred, nn5_pred, nn3_pred_std, nn5_pred_std, "(BNN)" + r'$^{\rm{DP}}_{1 \times 50}$', "(BNN)" + r'$^{\rm{DF-Mod\ 1}}_{1 \times 50}$', output_dir, "BNN_Flip_modV1_Flip_comparison", privateWork=options.isPrivateWork())
plot_correlation_two_NNs(nn3_pred, nn7_pred, nn3_pred_std, nn7_pred_std, "(BNN)" + r'$^{\rm{DP}}_{1 \times 50}$', "(BNN)" + r'$^{\rm{DF-Mod\ 2}}_{1 \times 50}$', output_dir, "BNN_Flip_modV3_Flip_comparison", privateWork=options.isPrivateWork())
...
plot_correlation_two_NNs(nn4_pred, nn6_pred, nn4_pred_std, nn6_pred_std, "(BNN)" + r'$^{\rm{DP,T}}_{1 \times 50}$', "(BNN)" + r'$^{\rm{DF-Mod\ 1,T}}_{1 \times 50}$', output_dir, "QT_BNN_Flip_modV1_Flip_comparison", privateWork=options.isPrivateWork())
plot_correlation_two_NNs(nn4_pred, nn8_pred, nn4_pred_std, nn8_pred_std, "(BNN)" + r'$^{\rm{DP,T}}_{1 \times 50}$', "(BNN)" + r'$^{\rm{DF-Mod\ 2,T}}_{1 \times 50}$', output_dir, "QT_BNN_Flip_modV3_Flip_comparison", privateWork=options.isPrivateWork())
...
plot_correlation_two_NNs(nn9_pred, nn5_pred, nn9_pred_std, nn5_pred_std, "(BNN)" + r'$^{\rm{DV-Mod\ A}}_{1 \times 50}$', "(BNN)" + r'$^{\rm{DF-Mod\ 1}}_{1 \times 50}$', output_dir, "BNN_modV1_Var_modV1_Flip_comparison", privateWork=options.isPrivateWork())
plot_correlation_two_NNs(nn9_pred, nn7_pred, nn9_pred_std, nn7_pred_std, "(BNN)" + r'$^{\rm{DV-Mod\ A}}_{1 \times 50}$', "(BNN)" + r'$^{\rm{DF-Mod\ 2}}_{1 \times 50}$', output_dir, "BNN_modV1_Var_modV3_Flip_comparison", privateWork=options.isPrivateWork())
...
plot_correlation_two_NNs(nn10_pred, nn6_pred, nn10_pred_std, nn6_pred_std, "(BNN)" + r'$^{\rm{DV-Mod\ A,T}}_{1 \times 50}$', "(BNN)" + r'$^{\rm{DF-Mod\ 1,T}}_{1 \times 50}$', output_dir, "QT_BNN_modV1_Var_modV1_Flip_comparison", privateWork=options.isPrivateWork())
plot_correlation_two_NNs(nn10_pred, nn8_pred, nn10_pred_std, nn8_pred_std, "(BNN)" + r'$^{\rm{DV-Mod\ A,T}}_{1 \times 50}$', "(BNN)" + r'$^{\rm{DF-Mod\ 2,T}}_{1 \times 50}$', output_dir, "QT_BNN_modV1_Var_modV3_Flip_comparison", privateWork=options.isPrivateWork())

# Comparison mod Var V2, mod Flip V1, mod Flip V3 (with and without QT)
plot_correlation_two_NNs(nn11_pred, nn5_pred, nn11_pred_std, nn5_pred_std, "(BNN)" + r'$^{\rm{DV-Mod\ A}}_{1 \times 50}$', "(BNN)" + r'$^{\rm{DF-Mod\ 1}}_{1 \times 50}$', output_dir, "BNN_modV2_Var_modV1_Flip_comparison", privateWork=options.isPrivateWork())
plot_correlation_two_NNs(nn11_pred, nn7_pred, nn11_pred_std, nn7_pred_std, "(BNN)" + r'$^{\rm{DV-Mod\ A}}_{1 \times 50}$', "(BNN)" + r'$^{\rm{DF-Mod\ 2}}_{1 \times 50}$', output_dir, "BNN_modV2_Var_modV3_Flip_comparison", privateWork=options.isPrivateWork())

plot_correlation_two_NNs(nn12_pred, nn6_pred, nn12_pred_std, nn6_pred_std, "(BNN)" + r'$^{\rm{DV-Mod\ A,T}}_{1 \times 50}$', "(BNN)" + r'$^{\rm{DF-Mod\ 1,T}}_{1 \times 50}$', output_dir, "QT_BNN_modV2_Var_modV1_Flip_comparison", privateWork=options.isPrivateWork())
plot_correlation_two_NNs(nn12_pred, nn8_pred, nn12_pred_std, nn8_pred_std, "(BNN)" + r'$^{\rm{DV-Mod\ A,T}}_{1 \times 50}$', "(BNN)" + r'$^{\rm{DF-Mod\ 2,T}}_{1 \times 50}$', output_dir, "QT_BNN_modV2_Var_modV3_Flip_comparison", privateWork=options.isPrivateWork())

# Comparison mod Flip V1, mod Flip V3 (with and without QT)
plot_correlation_two_NNs(nn5_pred, nn7_pred, nn5_pred_std, nn7_pred_std, "(BNN)" + r'$^{\rm{DF-Mod\ 1}}_{1 \times 50}$', "(BNN)" + r'$^{\rm{DF-Mod\ 2}}_{1 \times 50}$', output_dir, "BNN_modV1_Flip_modV3_Flip_comparison", privateWork=options.isPrivateWork())
plot_correlation_two_NNs(nn5_pred, nn8_pred, nn5_pred_std, nn8_pred_std, "(BNN)" + r'$^{\rm{DF-Mod\ 1,T}}_{1 \times 50}$', "(BNN)" + r'$^{\rm{DF-Mod\ 2,T}}_{1 \times 50}$', output_dir, "QT_BNN_modV1_Flip_modV3_Flip_comparison", privateWork=options.isPrivateWork())