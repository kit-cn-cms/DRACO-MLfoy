...
import variable_sets.DeepFlavourNodesVariableSet as variable_set
import net_config
...
inPath   = "/ceph/vanderlinden/MLFoyTrainData/DNN_newJEC_v2/"
...
input_samples.addSample("ttH"+naming, label = "ttH", signalSample = True, normalization_weight = 2.)
...
savepath = basedir+"/workdir/"+"btag_test_DeepFlavourNodes_newArch_"+str(JTcategory)
