...
import variable_sets.ttbarReco_GenVariables as variable_set
...
input_samples.addSample("ttZJets"+naming, label = "ttZJets", signalSample = True)
...
savepath = basedir+"/workdir/"+"ttbarReco_GenLevelTraining_v2_"+str(JTcategory)
...
dnn.plot_discriminators(signal_class = "ttZJets")
