...
import variable_sets.top10Variables_Z as variable_set
...
inPath   = "/ceph/vanderlinden/MLFoyTrainData/DNN_ttZJets/"
...
#input_samples.addSample("ttHbb"+naming, label = "ttHbb", signalSample = True, normalization_weight = 1.)
...
savepath = basedir+"/workdir/"+"ttZStudies_top10Variables_withZ_no_ttH_"+str(JTcategory)
