# python evaluating_models.py -i "/local/scratch/ssd/ycung/new_h5_files_2017_v2" -o comparison_default_models -c ge4j_ge3t -v new_variableset_25_v2 --binary -S ttH -q -P --restorefitdir /home/ycung/Desktop/DRACO-MLfoy_thesis/workdir/training_ANN_150N/QT_ANN_150N_training_0_ge4j_ge3t/fit_data.pck
# global imports
...
def ann_calc_mean_std(model, input_dir, n_NNs=1):
    ...
    for i in range(n_NNs):
        print "ITERATIONS " +input_dir.split("workdir/")[-1]+ ": " + str(i+1) + "/" + str(n_NNs)
...
input_dir_1 = work_dir+"Var_QT_BNN_training_50_ge4j_ge3t"
input_dir_2 = work_dir+"Var_BNN_training_50_ge4j_ge3t"
input_dir_3 = work_dir+"Flipout_QT_BNN_training_50_ge4j_ge3t"
input_dir_4 = work_dir+"Flipout_BNN_training_50_ge4j_ge3t"
input_dir_5 = work_dir+"training_ANN_150N/QT_ANN_150N_training"
input_dir_6 = work_dir+"training_ANN_150N/ANN_150N_training"
input_dir_7 = work_dir+"training_ANN_100N/QT_ANN_100N_training"
input_dir_8 = work_dir+"training_ANN_100N/ANN_100N_training"

nn1_pred, nn1_pred_std, labels1 = bnn_qt.load_trained_model(input_dir_1, n_iterations)
nn2_pred, nn2_pred_std, labels2 = bnn.load_trained_model(input_dir_2, n_iterations)
nn3_pred, nn3_pred_std, labels3 = bnnDP_qt.load_trained_model(input_dir_3, n_iterations)
nn4_pred, nn4_pred_std, labels4 = bnnDP.load_trained_model(input_dir_4, n_iterations)
...
nn7_pred, nn7_pred_std = ann_calc_mean_std(model=dnn_qt_100, input_dir=input_dir_7, n_NNs=n_iterations)
nn8_pred, nn8_pred_std = ann_calc_mean_std(model=dnn_100, input_dir=input_dir_8, n_NNs=n_iterations)
