...
# during preprocessing half of the ttH and ttbb sample is discarded (Even/Odd splitting),
...
input_samples.addSample("ttbb"+naming,  label = "ttbb", normalization_weight = 2.)
input_samples.addSample("tt2b"+naming,  label = "tt2b", normalization_weight = 2.)
