...
# define all samples
input_samples.addSample(options.getDefaultName("singlet"),  label = "singlet",  normalization_weight = options.getNomWeight(), total_weight_expr=weight)
input_samples.addSample(options.getDefaultName("ttsl"),  label = "ttsl",  normalization_weight = options.getNomWeight(), total_weight_expr=weight)
input_samples.addSample(options.getDefaultName("ttdl"), label = "ttdl", normalization_weight = options.getNomWeight(), total_weight_expr=weight)
