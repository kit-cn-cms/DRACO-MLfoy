# python eval_ANN_with_ttcc_only.py -i "/local/scratch/ssd/ycung/new_h5_files_2017_v2" -o comparison_ANN_only_ttcc -c ge4j_ge3t -v new_variableset_25_v2 --binary -S ttH -q -P --restorefitdir /home/ycung/Desktop/DRACO-MLfoy_thesis/workdir/training_ANN_150N/QT_ANN_150N_training_0_ge4j_ge3t/fit_data.pck
# global imports
...
n_iterations = 100
suffix = "_only_ttcc"
suffix_label = "nur " + r"$\mathregular{t\overline{t}+cc}$"
