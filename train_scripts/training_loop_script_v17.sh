...
layers=("50" "100" "200" "50,50" "50,50,50" "250" "300" "400" "500" "100,100" "150,150" "200,200" "250,250" "100,100,100" "150,150,150" "200,200,200" "250,250,250")

for i in "${!layers[@]}"; do
    python train_template_bnn_denseflipout_test.py -o $output1"${layers[$i]}"_v17 -i /local/scratch/ssd/nshadskiy/2017_nominal -c ge4j_ge3t -v allVariables_2017_bnn -n "$name" -p --printroc --binary --signal ttH -e $epochs -q --layers ${layers[$i]}
    python train_template_bnn_denseflipout_test.py -o $output2"${layers[$i]}"_v17 -i /local/scratch/ssd/nshadskiy/2017_nominal -c ge4j_ge3t -v allVariables_2017_bnn -n "$name" -p --printroc --binary --signal ttH -e $epochs --layers ${layers[$i]}
done