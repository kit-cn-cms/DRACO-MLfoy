...
input_samples.addSample(options.getDefaultName("tHQ"), label = "tHQ", normalization_weight = 1.)
input_samples.addSample(options.getDefaultName("tHW"), label = "tHW", normalization_weight = 1.)
