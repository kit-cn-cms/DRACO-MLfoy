...
class BNN():
    ...
    def build_default_model(self):
        ...
        def prior(kernel_size, bias_size=0, dtype=None):
            ...
            return tf.keras.Sequential([
                ...
                layers.DistributionLambda(lambda t: tfd.Independent(tfd.Normal(loc=t, scale=3.), reinterpreted_batch_ndims=1)), #[:n]#1e-5 + tf.math.softplus(c + t[n:])
                ])
    ...
    def plot_metrics(self, privateWork = False):
        ...
        for metric in metrics:
            ...
            # make it nicer
            german = {"acc": "Genauigkeit", "loss": "Verlust", "neg log likelihood": "negative Log-Likelihood"}
            #plt.grid()
