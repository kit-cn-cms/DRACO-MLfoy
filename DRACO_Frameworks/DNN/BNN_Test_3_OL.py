...
class BNN():
    ...
    def train_model(self):
        ...
        for num_layer in range(len(self.architecture["layers"])):
            ...
            #test not changing initialization of mean posterior
            initialize_posterior_weights = self.model.layers[num_layer+1].get_weights()[0][:num_param]
        ...
        #test not changing initialization of mean posterior
        initialize_OL_posterior_weights = self.model.layers[num_layer+2].get_weights()[0][:num_param]
