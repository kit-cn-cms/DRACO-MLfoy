...
class AdaBoost():
    ...
    def eval_model(self):
        ...
        plt.xlabel("Ada-Epochen", fontsize=13)
        plt.ylabel("ARK Ereignisse", fontsize=13)
        ...
        plt.xlim([0, 1])
        plt.ylim([0, 1])
        plt.xlabel('Anteil falsch positiv', fontsize=13)
        plt.ylabel('Anteil richtig positiv', fontsize=13)
