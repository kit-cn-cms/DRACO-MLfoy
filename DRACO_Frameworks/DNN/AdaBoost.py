...
class AdaBoost():
    ...
    def binned_likelihood(self, bkg_binns, tg_binns, mu):
        ...
        mu_range = 1.1  #Ada.M2 worked fine with 1.3
        ...
        s2y = [4, 4]
        #plotting
        plt.xlabel(r'$\mu$', fontsize=13,5)
        plt.ylabel(r'$-2 \log L$', fontsize=13,5)
        ...
        plt.title("CMS private work", loc="left", fontsize=13,5)
    ...
    def eval_model(self):
        ...
        plt.xlabel("Ada-Epochen", fontsize=13,5)
        plt.ylabel("ARK Ereignisse", fontsize=13,5)
        ...
        plt.xlim([0, 1])
        plt.ylim([0, 1])
        plt.xlabel('Anteil falsch positiv', fontsize=13,5)
        plt.ylabel('Anteil richtig positiv', fontsize=13,5)
        plt.tick_params(labelsize=13)
        ...
        # plt.figure(3)
        # # plt.title('Epsilon')
        # plt.xlabel("Epochen", fontsize=11)
