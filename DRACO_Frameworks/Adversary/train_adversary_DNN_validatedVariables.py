...
input_samples.addSample("ttbb_dnn_OL.h5",  label = "ttbb_OL", signalSample = True)
input_samples.addSample("ttb_dnn_OL.h5",  label = "ttb_OL", signalSample = True)
input_samples.addSample("tt2b_dnn_OL.h5",  label = "tt2b_OL", signalSample = True)
#input_samples.addSample("ttZ"+naming,   label = "ttZ", isTrainSample = False, signalSample = True)



# path to output directory (adjust NAMING)
savepath = basedir+"/workdir/masterthesis/lambda_"+str(10)+"_OL_redone_2/" +str(JTcategory)+"/"
...
dnn.build_default_adversary_model(penalty=10)
dnn.train_adversary_model()
