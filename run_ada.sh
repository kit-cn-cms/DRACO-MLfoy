...
epoches=("100") # "100" "150") #"200") -> overfitting
ada_epoches=("300")  #300
...
do
  ...
  do
    for conf in ${configs[*]};
    do
      python train_ada_template.py -i /ceph/swieland/ttH/h5Files/LegacyStrategy/Baseline -n _LegacyStrategyStudyBaseline.h5 --trainepochs $j --netconfig $conf --adaboost $i --binary -t -1 --signalclass ttH -c ge6j_ge3t --m2 True --simultan 5
      wait
