...
python -B train_scripts/train_ttHbb_DL.py -i ${TAG}/cate8 -o ${TAG}_training/cate8 -v variables_ttHbb_DL -n ttHbb_2017_DL -c ge4j_ge4t -p -R

rm -rf workdir/${TAG}_training_binary
python -B train_scripts/train_ttHbb_DL.py -i ${TAG}/cate8 -o ${TAG}_training_binary/cate8 -v variables_ttHbb_DL -n binary_DL -c ge4j_ge4t -p -R  --binary -t -1 --signal ttH
