...
variables["4j_ge3t"] = [
    ...
    'LooseJet_Charge[2]',
    'LooseJet_Charge[3]',
    'LooseJet_DeepJetCSV[0]',
    'LooseJet_DeepJetCSV[1]',
    'LooseJet_DeepJetCSV[2]',
    'LooseJet_DeepJetCSV[3]',
    'LooseJet_DeepJet_b[0]',
    'LooseJet_DeepJet_b[1]',
    'LooseJet_DeepJet_b[2]',
    'LooseJet_DeepJet_b[3]',
    'LooseJet_DeepJet_bb[0]',
    'LooseJet_DeepJet_bb[1]',
    'LooseJet_DeepJet_bb[2]',
    'LooseJet_DeepJet_bb[3]',
    'LooseJet_DeepJet_c[0]',
    'LooseJet_DeepJet_c[1]',
    'LooseJet_DeepJet_c[2]',
    'LooseJet_DeepJet_c[3]',
    'LooseJet_DeepJet_g[0]',
    'LooseJet_DeepJet_g[1]',
    'LooseJet_DeepJet_g[2]',
    'LooseJet_DeepJet_g[3]',
    'LooseJet_DeepJet_lepb[0]',
    'LooseJet_DeepJet_lepb[1]',
    'LooseJet_DeepJet_lepb[2]',
    'LooseJet_DeepJet_lepb[3]',
    'LooseJet_DeepJet_uds[0]',
    'LooseJet_DeepJet_uds[1]',
    'LooseJet_DeepJet_uds[2]',
    'LooseJet_DeepJet_uds[3]',
    'LooseJet_E[0]',
    'LooseJet_E[1]',
    'LooseJet_E[2]',
    'LooseJet_E[3]',
    ...
    #'TaggedJet_CSV[2]',
    #'TaggedJet_CSV[3]',
    'TaggedJet_DeepJetCSV[0]',
    'TaggedJet_DeepJetCSV[1]',
    #'TaggedJet_DeepJetCSV[2]',
    #'TaggedJet_DeepJetCSV[3]',
    'TaggedJet_DeepJet_b[0]',
    'TaggedJet_DeepJet_b[1]',
    #'TaggedJet_DeepJet_b[2]',
    #'TaggedJet_DeepJet_b[3]',
    'TaggedJet_DeepJet_bb[0]',
    'TaggedJet_DeepJet_bb[1]',
    #'TaggedJet_DeepJet_bb[2]',
    #'TaggedJet_DeepJet_bb[3]',
    'TaggedJet_DeepJet_c[0]',
    'TaggedJet_DeepJet_c[1]',
    #'TaggedJet_DeepJet_c[2]',
    #'TaggedJet_DeepJet_c[3]',
    'TaggedJet_DeepJet_g[0]',
    'TaggedJet_DeepJet_g[1]',
    #'TaggedJet_DeepJet_g[2]',
    #'TaggedJet_DeepJet_g[3]',
    'TaggedJet_DeepJet_lepb[0]',
    'TaggedJet_DeepJet_lepb[1]',
    #'TaggedJet_DeepJet_lepb[2]',
    #'TaggedJet_DeepJet_lepb[3]',
    'TaggedJet_DeepJet_uds[0]',
    'TaggedJet_DeepJet_uds[1]',
    #'TaggedJet_DeepJet_uds[2]',
    #'TaggedJet_DeepJet_uds[3]',
    'TaggedJet_E[0]',
    'TaggedJet_E[1]',
    #'TaggedJet_E[2]',
    #'TaggedJet_E[3]',
...
variables["ge4j_3t_0f"] = variables["4j_ge3t"]
variables["ge4j_ge4t_0f"] = variables["5j_ge3t"]
variables["ge4j_ge3t_ge1f"] = variables["ge6j_ge3t"]
