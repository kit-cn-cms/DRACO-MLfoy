...
variables["pT_lepTop"]          = Variable(bin_range = [0.,500.])
...
variables["pT_ZBoson"]          = Variable(bin_range = [0.,400.])
...
variables["mass_Boson"]                 = Variable(bin_range = [70.,130.])

variables["dY_lepTop_lepB"]         = Variable(bin_range = [0.,5.])
...
variables["dY_Lepton_lepTop"]           = Variable(bin_range = [0.,5.])
...
variables["y_Lepton"]           = Variable(bin_range = [-3.,3.])
...
variables["dEta_Boson_ttbar"]           = Variable(bin_range = [0.,5.])
...
variables["pT_ttX"]         = Variable(bin_range = [0.0,1000.])
