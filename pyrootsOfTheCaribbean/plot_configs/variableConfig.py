...
variables["Jet_DeepFlavourCSV[0]"]                      = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavourCSV[1]"]                      = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavourCSV[2]"]                      = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavourCSV[3]"]                      = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepCSV_b[0]"]                   = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepCSV_bb[0]"]                  = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepCSV_c[0]"]                   = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepCSV_udsg[0]"]                        = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_b[0]"]                       = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_bb[0]"]                      = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_c[0]"]                       = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_g[0]"]                       = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_lepb[0]"]                    = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_uds[0]"]                     = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepCSV_b[1]"]                   = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepCSV_bb[1]"]                  = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepCSV_c[1]"]                   = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepCSV_udsg[1]"]                        = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_b[1]"]                       = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_bb[1]"]                      = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_c[1]"]                       = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_g[1]"]                       = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_lepb[1]"]                    = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_uds[1]"]                     = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepCSV_b[2]"]                   = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepCSV_bb[2]"]                  = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepCSV_c[2]"]                   = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepCSV_udsg[2]"]                        = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_b[2]"]                       = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_bb[2]"]                      = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_c[2]"]                       = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_g[2]"]                       = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_lepb[2]"]                    = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_uds[2]"]                     = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepCSV_b[3]"]                   = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepCSV_bb[3]"]                  = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepCSV_c[3]"]                   = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepCSV_udsg[3]"]                        = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_b[3]"]                       = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_bb[3]"]                      = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_c[3]"]                       = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_g[3]"]                       = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_lepb[3]"]                    = Variable(bin_range = [0.0,1.0])
variables["Jet_DeepFlavour_uds[3]"]                     = Variable(bin_range = [0.0,1.0])
