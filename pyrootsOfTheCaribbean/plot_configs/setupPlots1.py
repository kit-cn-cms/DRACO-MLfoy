...
# ===============================================
def printLumi(pad, lumi = 57.9, ratio = False, twoDim = False):
    if lumi == 0.: return
...
# aus Einfachheit einfach mit privatework vertauscht, damit DRACO nicht den ganzen Plot umbaut
    pad.cd(1)
    l = pad.GetLeftMargin()
    t = pad.GetTopMargin()
    r = pad.GetRightMargin()
...
#    else:       latex.DrawLatex(l+0.50,1.-t+0.02, catLabel)
