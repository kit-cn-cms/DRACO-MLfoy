...
"Jet_CSV[0]":		                                    {"nbins": default, "bin_range": [0.,1.]},

"Jet_Pt[1]":		                                    {"nbins": default, "bin_range": [25.,400.]},
"Jet_Eta[1]":		                                    {"nbins": default, "bin_range": [-2.5,2.5]},
"Jet_CSV[1]":		                                    {"nbins": default, "bin_range": [0.,1.]},

"Jet_Pt[2]":		                                    {"nbins": default, "bin_range": [25.,400.]},
"Jet_Eta[2]":		                                    {"nbins": default, "bin_range": [-2.5,2.5]},
"Jet_CSV[2]":		                                    {"nbins": default, "bin_range": [0.,1.]},

"Jet_Pt[3]":		                                    {"nbins": default, "bin_range": [25.,400.]},
"Jet_Eta[3]":		                                    {"nbins": default, "bin_range": [-2.5,2.5]},
"Jet_CSV[3]":		                                    {"nbins": default, "bin_range": [0.,1.]},

"LooseLepton_Pt[0]":                                    {"nbins": default, "bin_range": [25.,400.]},
"LooseLepton_Eta[0]":		                            {"nbins": default, "bin_range": [-2.5,2.5]},

"Evt_HT":		                                        {"nbins": default, "bin_range": [0.,1500.]},
"BDT_common5_input_HT_tag":		                        {"nbins": default , "bin_range": [0.,1500.]},

"Evt_Dr_MinDeltaRJets":		                            {"nbins": default, "bin_range": [0.4,3.5]},
"Evt_Dr_MinDeltaRTaggedJets":		                    {"nbins": default, "bin_range": [0.4,3.5]},
...
"BDT_common5_input_aplanarity_jets":		            {"nbins": default , "bin_range": [0., 0.5]},
"BDT_common5_input_aplanarity_tags":		            {"nbins": default , "bin_range": [0., 0.5]},

"Evt_JetPtOverJetE":		                            {"nbins": default, "bin_range": [0.2,1.0]},
"BDT_common5_input_pt_all_jets_over_E_all_jets_tags":	{"nbins": default, "bin_range": [0.2,1.0]},
...
"Evt_Dr_MinDeltaRLeptonJet":		                    {"nbins": default, "bin_range": [0.4,3.5]},
"Evt_Dr_MinDeltaRLeptonTaggedJet":		                {"nbins": default, "bin_range": [0.4,3.5]},
...
"Evt_Dr_TaggedJetsAverage":		                        {"nbins": default, "bin_range": [0.5,4.0]},
...
"Evt_M_JetsAverage":                                    {"nbins": default, "bin_range": [0.,40.]},
"Evt_M2_TaggedJetsAverage":		                        {"nbins": default, "bin_range": [0.,1000.]},

"N_BTagsT":	                                           	{"nbins": 5, "bin_range": [-0.5,4.5]},

"BDT_common5_input_tagged_dijet_mass_closest_to_125":	{"nbins": default, "bin_range": [0.,350.]},
...
"GenAdd_BB_inacceptance":		                        {"nbins": 2, "bin_range": [0.,1.]},
"GenAdd_B_inacceptance":		                        {"nbins": 2, "bin_range": [0.,1.]},
"GenHiggs_BB_inacceptance":		                        {"nbins": 2, "bin_range": [0.,1.]},
"GenHiggs_B_inacceptance":		                        {"nbins": 2, "bin_range": [0.,1.]},
"GenTopHad_B_inacceptance":		                        {"nbins": 2, "bin_range": [0.,1.]},
"GenTopHad_QQ_inacceptance":		                    {"nbins": 2, "bin_range": [0.,1.]},
"GenTopHad_Q_inacceptance":		                        {"nbins": 2, "bin_range": [0.,1.]},
"GenTopLep_B_inacceptance":                             {"nbins": 2, "bin_range": [0.,1.]}
}
