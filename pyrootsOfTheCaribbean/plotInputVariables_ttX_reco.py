...
plotter.addSample(
    ...
    sampleFile      = data_dir+"/bkg_Higgs"+naming,
    XSscaling       = 1.,
...
plotter.addSample(
    sampleName      = "bkg_Z",
    sampleFile      = data_dir+"/bkg_Z"+naming,
    XSscaling       = 1.,
...
plotter.addSample(
    sampleName      = "bkg_bb",
    sampleFile      = data_dir+"/bkg_bb"+naming,
    XSscaling       = 1.,
...
plotter.addSample(
    sampleName      = "bkg_cc",
    sampleFile      = data_dir+"/bkg_cc"+naming,
    XSscaling       = 1.,
...
plotter.addSample(
    ...
    sampleFile      = data_dir+"/bkg_bbfromttbar"+naming,
    XSscaling       = 1.,
    plotColor       = ROOT.kGray)

# add JT categories
plotter.addCategory("ge4j_ge3t")
#plotter.addCategory("ge6j_ge4t")
