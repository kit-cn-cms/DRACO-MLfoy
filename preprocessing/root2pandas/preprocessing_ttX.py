...
#ttH_categories.addCategory("ttX",       selection = "(matchH_ft_RecoX_matchable < 100. and matchZ_ft_RecoX_matchable < 100.)")
...
#ttZ_categories.addCategory("ttX",       selection = "(matchH_ft_RecoX_matchable < 100. and matchZ_ft_RecoX_matchable < 100.)")
