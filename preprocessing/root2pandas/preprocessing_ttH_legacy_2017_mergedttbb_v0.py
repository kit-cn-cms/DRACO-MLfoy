...
python preprocessing_ttH_legacy_2017_mergedttbb_v0.py -o ttH_legacy_2017_mergedttbb_v0 -v ttH_legacy_2017_Top30 -n ttH_legacy_2017_mergedttbb_v0
"""
...
dataset.addSample(
    sampleName  = "TTbb",
    ntuples     = "/TTbb_Powheg_Openloops_new_pmx/*nominal*.root",
