...
python preprocessing_ttH_legacy_2017_v0.py -o ttH_legacy_2017_v0 -v ttH_legacy_2017_Top30 -n ttH_legacy_2017_v0
"""
...
ttbar_categories.addCategory("ttb_bb", selection =  "(GenEvt_I_TTPlusBB == 3 and GenEvt_I_TTPlusCC == 0) or \
...
ttbar_categories.addCategory("tthf", selection =    "(GenEvt_I_TTPlusBB == 3 and GenEvt_I_TTPlusCC == 0) or \
...
dataset.addSample(
    ...
    MEMs        = memPath+"/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8_new_pmx/*.root",
      )
