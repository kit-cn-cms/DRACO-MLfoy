...
ttH_categories.addCategory("ttH_g1000HT", selection = "Evt_HT > 1000")
ttH_categories.addCategory("ttH_l1000HT", selection = "Evt_HT <= 1000 and Evt_HT > 500")
ttH_categories.addCategory("ttH_le500HT", selection = "Evt_HT <= 500")

#ttHNonbb_categories = root2pandas.EventCategories()
#ttHNonbb_categories.addCategory("ttHNonbb_HTXS_hiPt", selection = "HTXS_GenHiggs_Pt > 130")
#ttHNonbb_categories.addCategory("ttHNonbb_HTXS_loPt", selection = "HTXS_GenHiggs_Pt <= 130")
