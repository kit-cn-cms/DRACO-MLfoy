...
base = "(N_Jets >= 4 and N_BTagsM >= 3 and ttbarReco_matchable > 0.)"  #adjusted
...
ntuplesPath = "/nfs/dust/cms/user/epfeffer/observ_studies/ntuples/friendTrees/matched_ttbar_system/TTbb_4f_TTToSemiLeptonic_TuneCP5-Powheg-Openloops-Pythia8/" #adjusted
