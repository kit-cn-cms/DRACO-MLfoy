...
ttH_categories = root2pandas.EventCategories("ttH_categories")
ttH_categories.addCategory("ttH", selection = None)

ttbar_categories = root2pandas.EventCategories("ttbar_categories")
...
ntuplesPath2016 = "/nfs/dust/cms/user/swieland/ttH_legacy/ntuple/2016"
...
dataset.addSample(
    sampleName  = "ttH2017",
    ntuples     = ntuplesPath2017+"/ttHTobb_M125_TuneCP5_13TeV-powheg-pythia8/*nominal*.root",
    categories  = ttH_categories,
    dataera     = 2017,
    even_odd    = options.even_odd_splitting,
   ) 
...
dataset.addSample(
    sampleName  = "TTTo2017",
    ntuples     = ntuplesPath2017+"/TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8/*nominal*.root",
    categories  = ttbar_categories,
    dataera     = 2017,
    even_odd    = options.even_odd_splitting,
      )
