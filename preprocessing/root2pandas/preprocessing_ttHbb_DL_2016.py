...
for i in range(15):
    dataset.addSample(
      ...
      ntuples    = ntuplesPath+"/*/*_ttbarH125tobbbar_2L_TuneCP5_"+str(i)+".root",
...
for i in range(5):
    ...
    dataset.addSample(
        sampleName  = "ttbar_categories_ttbarNotau_bb"+str(i),
        ntuples     = ntuplesPath+"/*/*_ttbarDileptonNotauBbbar_fromDilepton_TuneCP5_"+str(i)+".root",
        categories  = ttbar_categories,
        selections  = None
    )
    dataset.addSample(
        sampleName  = "ttbar_categories_ttbarOnlytau_bb"+str(i),
        ntuples     = ntuplesPath+"/*/*_ttbarDileptonOnlytauBbbar_fromDilepton_TuneCP5_"+str(i)+".root",
        categories  = ttbar_categories,
        selections  = None
    )
...
for i in range(5):
    ...
    dataset.addSample(
        sampleName  = "ttbar_categoriesttbarNotau_b"+str(i),
        ntuples     = ntuplesPath+"/*/*_ttbarDileptonNotauB_fromDilepton_TuneCP5_"+str(i)+".root",
        categories  = ttbar_categories,
        selections  = None
    )
    dataset.addSample(
        sampleName  = "ttbar_categoriesttbarOnlytau_b"+str(i),
        ntuples     = ntuplesPath+"/*/*_ttbarDileptonOnlytauB_fromDilepton_TuneCP5_"+str(i)+".root",
        categories  = ttbar_categories,
        selections  = None
    )
...
for i in range(5):
    ...
    dataset.addSample(
        sampleName  = "ttbar_categoriesttbarNotau_2b"+str(i),
        ntuples     = ntuplesPath+"/*/*_ttbarDileptonNotau2b_fromDilepton_TuneCP5_"+str(i)+".root",
        categories  = ttbar_categories,
        selections  = None
    )
    dataset.addSample(
        sampleName  = "ttbar_categoriesttbarOnlytau_2b"+str(i),
        ntuples     = ntuplesPath+"/*/*_ttbarDileptonOnlytau2b_fromDilepton_TuneCP5_"+str(i)+".root",
        categories  = ttbar_categories,
        selections  = None
    )
