...
ntuplesPath = "/nfs/dust/cms/user/mmarz/tuple/snape/complete/FatJetClean/2018/"
...
# Signal
dataset.addSample(
    sampleName = "Sig_MH600_hSBB",
    ntuples    = ntuplesPath+"Signal_nanoaodv9_UL_MH600_MhS60_hSToBB_hToTauTau"+"/*tree*.root",
...
dataset.addSample(
    sampleName = "Sig_MH600_hSTauTau",
    ntuples    = ntuplesPath+"Signal_nanoaodv9_UL_MH600_MhS60_hSToTauTau_hToBB"+"/*tree*.root",
...
dataset.addSample(
    sampleName = "Sig_MH700_hSBB",
    ntuples    = ntuplesPath+"Signal_nanoaodv9_UL_MH700_MhS60_hSToBB_hToTauTau"+"/*tree*.root",
...
dataset.addSample(
    sampleName = "Sig_MH700_hSTauTau",
    ntuples    = ntuplesPath+"Signal_nanoaodv9_UL_MH700_MhS60_hSToTauTau_hToBB"+"/*tree*.root",
...
dataset.addSample(
    sampleName = "Sig_MH800_hSBB",
    ntuples    = ntuplesPath+"Signal_nanoaodv9_UL_MH800_MhS60_hSToBB_hToTauTau"+"/*tree*.root",
...
dataset.addSample(
    sampleName = "Sig_MH800_hSTauTau",
    ntuples    = ntuplesPath+"Signal_nanoaodv9_UL_MH800_MhS60_hSToTauTau_hToBB"+"/*tree*.root",
...
dataset.addSample(
    sampleName = "Sig_MH900_hSBB",
    ntuples    = ntuplesPath+"Signal_nanoaodv9_UL_MH900_MhS60_hSToBB_hToTauTau"+"/*tree*.root",
...
dataset.addSample(
    sampleName = "Sig_MH900_hSTauTau",
    ntuples    = ntuplesPath+"Signal_nanoaodv9_UL_MH900_MhS60_hSToTauTau_hToBB"+"/*tree*.root",
...
dataset.addSample(
    sampleName = "Sig_MH1000_hSBB",
    ntuples    = ntuplesPath+"Signal_nanoaodv9_UL_MH1000_MhS60_hSToBB_hToTauTau"+"/*tree*.root",
...
dataset.addSample(
    sampleName = "Sig_MH1000_hSTauTau",
    ntuples    = ntuplesPath+"Signal_nanoaodv9_UL_MH1000_MhS60_hSToTauTau_hToBB"+"/*tree*.root",
...
dataset.addSample(
    sampleName = "Sig_MH1200_hSBB",
    ntuples    = ntuplesPath+"Signal_nanoaodv9_UL_MH1200_MhS60_hSToBB_hToTauTau"+"/*tree*.root",
...
dataset.addSample(
    sampleName = "Sig_MH1200_hSTauTau",
    ntuples    = ntuplesPath+"Signal_nanoaodv9_UL_MH1200_MhS60_hSToTauTau_hToBB"+"/*tree*.root",
...
dataset.addSample(
    ...
    ntuples    = ntuplesPath+"TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8"+"/*tree*.root",
...
dataset.addSample(
    sampleName = "TTToSemi",
    ntuples    = ntuplesPath+"TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8"+"/*tree*.root",
    categories = ttbar_categories,
    selections = None,
    friendTrees = friendTrees
)
...
dataset.addSample(
    ...
    ntuples    = ntuplesPath+"TTToHadronic_TuneCP5_13TeV-powheg-pythia8"+"/*tree*.root",
    categories = ttbar_categories,
    selections = None,
    friendTrees = friendTrees
)
...
dataset.addSample(
    ...
    ntuples    = ntuplesPath+"EWKZ2Jets_ZToLL_M-50_TuneCP5_withDipoleRecoil_13TeV-madgraph-pythia8"+"/*tree*.root",
...
dataset.addSample(
    ...
    ntuples    = ntuplesPath+"DYJetsToLL_M-10to50_TuneCP5_13TeV-madgraphMLM-pythia8"+"/*tree*.root",
    categories = Zll_categories,
    selections = None,
    friendTrees = friendTrees
)
...
dataset.addSample(
    ...
    ntuples    = ntuplesPath+"DYJetsToLL_M-50_HT-70to100_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8"+"/*tree*.root",
    categories = Zll_categories,
    selections = None,
    friendTrees = friendTrees
)
...
dataset.addSample(
    sampleName = "DYJets_100to200",
    ntuples    = ntuplesPath+"DYJetsToLL_M-50_HT-100to200_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8"+"/*tree*.root",
    categories = Zll_categories,
    selections = None,
    friendTrees = friendTrees
)
...
dataset.addSample(
    sampleName = "DYJets_200to400",
    ntuples    = ntuplesPath+"DYJetsToLL_M-50_HT-200to400_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8"+"/*tree*.root",
    categories = Zll_categories,
    selections = None,
    friendTrees = friendTrees
)
...
dataset.addSample(
    ...
    ntuples    = ntuplesPath+"DYJetsToLL_M-50_HT-400to600_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8"+"/*tree*.root",
    categories = Zll_categories,
    selections = None,
    friendTrees = friendTrees
)
...
dataset.addSample(
    ...
    ntuples    = ntuplesPath+"DYJetsToLL_M-50_HT-600to800_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8"+"/*tree*.root",
    categories = Zll_categories,
    selections = None,
    friendTrees = friendTrees
)
...
dataset.addSample(
    ...
    ntuples    = ntuplesPath+"DYJetsToLL_M-50_HT-800to1200_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8"+"/*tree*.root",
    categories = Zll_categories,
    selections = None,
    friendTrees = friendTrees
)
...
dataset.addSample(
    ...
    ntuples    = ntuplesPath+"DYJetsToLL_M-50_HT-1200to2500_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8"+"/*tree*.root",
    categories = Zll_categories,
    selections = None,
    friendTrees = friendTrees
)
...
dataset.addSample(
    ...
    ntuples    = ntuplesPath+"DYJetsToLL_M-50_HT-2500toInf_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8"+"/*tree*.root",
    categories = Zll_categories,
    selections = None,
    friendTrees = friendTrees
)
...
dataset.addSample(
    ...
    ntuples    = ntuplesPath+"WJetsToLNu_HT-70To100_TuneCP5_13TeV-madgraphMLM-pythia8"+"/*tree*.root",
...
dataset.addSample(
    ...
    ntuples    = ntuplesPath+"WJetsToLNu_HT-100To200_TuneCP5_13TeV-madgraphMLM-pythia8"+"/*tree*.root",
    categories = Wjet_categories,
    selections = None,
    friendTrees = friendTrees
)
...
dataset.addSample(
    ...
    ntuples    = ntuplesPath+"WJetsToLNu_HT-200To400_TuneCP5_13TeV-madgraphMLM-pythia8"+"/*tree*.root",
    categories = Wjet_categories,
    selections = None,
    friendTrees = friendTrees
)
...
dataset.addSample(
    ...
    ntuples    = ntuplesPath+"WJetsToLNu_HT-400To600_TuneCP5_13TeV-madgraphMLM-pythia8"+"/*tree*.root",
    categories = Wjet_categories,
    selections = None,
    friendTrees = friendTrees
)
...
dataset.addSample(
    ...
    ntuples    = ntuplesPath+"WJetsToLNu_HT-600To800_TuneCP5_13TeV-madgraphMLM-pythia8"+"/*tree*.root",
    categories = Wjet_categories,
    selections = None,
    friendTrees = friendTrees
)
...
dataset.addSample(
    ...
    ntuples    = ntuplesPath+"WJetsToLNu_HT-800To1200_TuneCP5_13TeV-madgraphMLM-pythia8"+"/*tree*.root",
    categories = Wjet_categories,
    selections = None,
    friendTrees = friendTrees
)
...
dataset.addSample(
    ...
    ntuples    = ntuplesPath+"WJetsToLNu_HT-1200To2500_TuneCP5_13TeV-madgraphMLM-pythia8"+"/*tree*.root",
    categories = Wjet_categories,
    selections = None,
    friendTrees = friendTrees
)
...
dataset.addSample(
    ...
    ntuples    = ntuplesPath+"WJetsToLNu_HT-2500ToInf_TuneCP5_13TeV-madgraphMLM-pythia8"+"/*tree*.root",
    categories = Wjet_categories,
    selections = None,
    friendTrees = friendTrees
)
