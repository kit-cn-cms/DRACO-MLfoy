...
ttH_categories.addCategory("ttH_0", selection = "GenHiggs_Pt<=60")
ttH_categories.addCategory("ttH_1", selection = "GenHiggs_Pt > 60 and GenHiggs_Pt <= 120")
ttH_categories.addCategory("ttH_2", selection = "GenHiggs_Pt > 120 and GenHiggs_Pt <= 200")
ttH_categories.addCategory("ttH_3", selection = "GenHiggs_Pt > 200 and GenHiggs_Pt <= 300")
ttH_categories.addCategory("ttH_4", selection = "GenHiggs_Pt > 300")
ttH_categories.addCategory("ttH", selection = "")
...
ttH_ntuplesPath = "/nfs/dust/cms/user/swieland/ttH_legacy/ntuple/2017/"
#ttH_ntuplesPath = "/nfs/dust/cms/user/pkraemer/ttH_HTXS/M_ttH_Ntuples"
ttbar_ntuplesPath = "/nfs/dust/cms/user/swieland/ttH_legacy/ntuple/2017/"
...
dataset.addSample(
    sampleName  = "ttHbb",
    ntuples     = ttH_ntuplesPath+"/ttHTobb_M125_TuneCP5_13TeV-powheg-pythia8/*nominal*.root",
...
#dataset.addSample(
#    sampleName  = "ttHNonbb",
#    ntuples     = ttH_ntuplesPath+"/ttHToNonbb_M125_TuneCP5_13TeV-powheg-pythia8/*nominal*.root",
