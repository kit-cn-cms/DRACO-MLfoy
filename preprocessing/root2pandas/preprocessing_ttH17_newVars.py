...
dataset.addSample(
    sampleName  = "ttHbb",
    ntuples     = ntuplesPath+"/ttHTobb_M125_TuneCP5_13TeV-powheg-pythia8/*pythia8_16*nominal*.root",
...
dataset.addSample(
    sampleName  = "ttHNonbb",
    ntuples     = ntuplesPath+"/ttHToNonbb_M125*/*nominal*.root",
    categories  = ttH_categories,
    #MEMs        = memPath+"/ttHTobb_M125_TuneCP5_13TeV-powheg-pythia8/*.root",
    even_odd    = options.even_odd_splitting,
    ) 
...
dataset.addSample(
    sampleName  = "TTToSL",
    ntuples     = ntuplesPath+"/TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8/*nominal*.root",
...
dataset.addSample(
    sampleName  = "tHq",
    ntuples     = ntuplesPath+"/THW_*ctcvcp*/*nominal*.root",
...
dataset.addSample(
    sampleName  = "tHW",
    ntuples     = ntuplesPath+"/THQ_*ctcvcp*/*nominal*.root",
    categories  = tH_categories,
    even_odd    = options.even_odd_splitting,
    )
...
dataset.addSample(
    sampleName  = "ST_s",
    ntuples     = ntuplesPath+"/ST_s-channel_4f_leptonDecays_TuneCP5_PSweights_13TeV*/*nominal*.root",
    categories  = ST_categories,
    even_odd    = options.even_odd_splitting,
    )
dataset.addSample(
    sampleName  = "ST_t_top",
    ntuples     = ntuplesPath+"/ST_t-channel_top_4f_InclusiveDecays_TuneCP5_13TeV*/*nominal*.root",
    categories  = ST_categories,
    even_odd    = options.even_odd_splitting,
    )
dataset.addSample(
    sampleName  = "ST_t_topbar",
    ntuples     = ntuplesPath+"/ST_t-channel_antitop_4f_InclusiveDecays_TuneCP5_13TeV*/*nominal*.root",
    categories  = ST_categories,
    even_odd    = options.even_odd_splitting,
    )
dataset.addSample(
    sampleName  = "ST_tW_top",
    ntuples     = ntuplesPath+"/ST_tW_top_5f_inclusiveDecays_TuneCP5_PSweights_13TeV-powheg-pythia8/*nominal*.root",
    categories  = ST_categories,
    even_odd    = options.even_odd_splitting,
    )
dataset.addSample(
    sampleName  = "ST_tW_topbar",
    ntuples     = ntuplesPath+"/ST_tW_antitop_5f_inclusiveDecays_TuneCP5_PSweights_13TeV-powheg-pythia8/*nominal*.root",
    categories  = ST_categories,
    even_odd    = options.even_odd_splitting,
    )
