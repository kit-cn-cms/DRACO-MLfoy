...
dataset.addSample(
    sampleName  = "ttH",
    ntuples     = ntuplespath+"/ttHTobb*/*nominal_Tree.root",
...
dataset.addSample(
    sampleName  = "ttZ",
    ntuples     = ntuplespath+"/TTZToQQ*/*nominal_Tree.root",
...
dataset.addSample(
    sampleName  = "ttbar",
    ntuples     = ntuplespath+"/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8_new_pmx/*nominal_Tree.root",
...
dataset.addSample(
    sampleName  = "ttbb",
    ntuples     = ntuplespath+"/TTbb_Powheg_Openloops_new_pmx/*nominal_Tree.root",
